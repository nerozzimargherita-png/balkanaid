...
Flutter (Android-first), flutter_map con OpenStreetMap e cache offline, Supabase come backend, flutter_localizations con file ARB, flutter_svg per icone e pin.
